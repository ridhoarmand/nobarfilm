  ...
  return (
    <div className="py-8">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-3xl font-bold text-white">NetShort</h1>
      </div>
      ...
      <div className="text-center py-12">
        ...
        <h2 className="text-2xl font-bold text-white mb-2">NetShort Content</h2>
        <p className="text-gray-400 max-w-md mx-auto mb-6">
          Enjoy short dramas and series from NetShort. A great platform for bite-sized entertainment.
        </p>
