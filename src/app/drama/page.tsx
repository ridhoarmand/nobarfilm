      ...
      <main className="bg-black min-h-screen pt-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-20">
            ...
            <h1 className="text-4xl font-bold text-white mb-4">Drama Section</h1>
            <p className="text-gray-400 text-lg mb-8">Coming Soon! We're working on bringing you the best drama content.</p>
