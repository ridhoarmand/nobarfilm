...
export function AudioSubtitlePopover({
  ...
  return (
    <div className="absolute bottom-16 right-4 sm:right-16 z-50 w-[calc(100vw-2rem)] sm:w-[460px] max-h-[82vh] overflow-y-auto bg-zinc-950/95 border border-zinc-800/90 text-white rounded-2xl shadow-2xl backdrop-blur-2xl p-4 sm:p-5 animate-fade-in scrollbar-thin">
      {/* Header */}
