...
export function DracinCardSkeleton({ index = 0 }: DramaCardSkeletonProps) {
  return (
    <div className="rounded-2xl overflow-hidden animate-fade-up w-full" style={{ animationDelay: `${index * 50}ms` }}>
      {/* Cover Skeleton */}
