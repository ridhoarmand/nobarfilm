'use client';import { UnifiedMediaCard } from '@/components/cards/UnifiedMediaCard';
...
export function InfiniteDracinSection({ title }: InfiniteDramaSectionProps) {
  const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading, isError, refetch } = useInfiniteForYouDramas();
